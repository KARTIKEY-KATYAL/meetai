      ...
      <Card className="overflow-hidden p-0">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="p-6 md:p-8">
            ...
            <div className="text-center text-sm mt-4">
                Have an Account? {" "} 
                <Link href="/sign-in" className="underline underline-offset-4">Log In</Link>
            </div>
        </form>
        </Form>
        <div className="bg-gradient-to-br from-green-600 to-green-800 relative hidden md:flex flex-col gap-y-4 items-center justify-center">
            ...
            <p className="text-green-100 text-center max-w-xs">
                Connect, collaborate, and achieve more together with our AI-powered meeting platform.
            </p>
        </div>
        </CardContent>
        </Card>
